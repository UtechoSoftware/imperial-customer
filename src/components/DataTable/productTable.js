...
import { arrowleft2, arrowright2, filter, filterIcon, plus, plusWhite, pluscircle, searchbar, searchnormal } from '../icons/icon'
...
const ProductTable = ({ data,navigation,showSearch, columns,setSearch,search, currentPage,buttontext, showRow, rowHeading, setCurrentPage, setLastId, count, loading }) => {
                        ...
                        <div className='flex items-center justify-between flex-wrap p-3 max-md:gap-3 w-full'>
                            ...
                            <div className='d-flex gap-3'>
                                        ...
                                        {/* <button className="flex items-center gap-2 border rounded-lg py-[8px] px-[14px]">
                                            ...
                                            <span className='plusJakara_semibold text_black text-sm'>Filters</span>
                                        </button> */}
                                        <button onClick={()=>navigate(`${navigation}`)} className="flex items-center gap-2 border bg_primary text-white rounded-lg py-[8px] px-[14px]">
                                        <img style={{color:"white"}} src={plusWhite} alt="" />

                                            <span className='plusJakara_semibold text-sm'>{buttontext}</span>
                                        </button>
                                    </div>
                                    {
                                        showSearch===true ? '' : 
