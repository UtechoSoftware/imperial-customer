        ...
        <main className='min-h-screen lg:container py-4 px-4 mx-auto'>
            <div className="flex justify-between flex-wrap gap-3 items-center w-full">
                <div className="flex flex-col mb-3">
                    <h2 className='plusJakara_bold text_black'>Educational Pathways</h2>
                    <h6 className="text_secondary plusJakara_regular">Information about your current plan and usages</h6>
                </div>

                <button onClick={() => { navigate('/course-category/add-course') }} style={{ minWidth: '230px' }} className="bg_primary py-3 rounded-3 text_white plusKajara_semibold">Add Educational Pathway</button>
            </div>
            {/* <Form.Group className='shadow_def px-3 mb-3'> */}
            {/* <div className="responsive_">
                <Form.Label className="plusJakara_semibold text_dark">Category Type</Form.Label>
                <Select
                    value={category}
                    onChange={setCategory}
                    options={options}
                    styles={customStyles}
                    className='custom_control rounded-3 plusJakara_regular text_secondarydark bg_white'
                ...
                <Modal show={showModal} onHide={() => setShowModal(false)} centered>
                    <Modal.Body>
                        ...
                        <Form onSubmit={handleUpdate}>
                            ...
                            <Form.Group className='shadow_def px-3 mb-3'>
                                <Form.Label className="plusJakara_semibold text_dark">Educational Pathway Name</Form.Label>
                                <Form.Control
                                    type='text'
                                    required
                                    value={title}
                            ...
                            <div className="flex justify-content-end my-4 w-100">
                                {!isProcessing ? (
                                    <button
                                        ...
                                        <span className="plusJakara_semibold text_white">Update Educational Pathway</span>
                                    </button>
                                ) : (
