      ...
      <main className="min-h-screen lg:container py-4 px-4 mx-auto">
        <div className="flex justify-between flex-wrap gap-3 items-center w-full">
          <div className="flex flex-col mb-3">
            <h2 className="plusJakara_bold text_black">
              Parent Side Digital Products
            </h2>
          ...
          <button
            onClick={() => {
              navigate("/digital-products-parent/add-product");
            }}
            style={{ minWidth: "150px" }}
            className="bg_primary py-3 rounded-3 text_white plusJakara_medium"
          >
            Add New Product
          </button>
        </div>
